...
对 MoonBit 生态 21 个开源项目（总计 3,676 个文件）的全流程扫描结果：
...
| [mizchi/luna.mbt](https://github.com/mizchi/luna.mbt) | 162 | 466 | 128 | CRLF 注入 (14)、abort (28)、unsafe 类型转换 (15)、unsafe cast (71) |
...
| [mizchi/js.mbt](https://github.com/mizchi/js.mbt) | 74 | 196 | 60 | abort (5)、unsafe cast (55) |
...
| [moonbitlang/maria](https://github.com/moonbitlang/maria) | 43 | 266 | 19 | abort (11)、unsafe 类型转换 (6)、unsafe cast (2) |
...
| [moonbitlang/openseek](https://github.com/nicholasgasior/openseek) | 32 | 291 | 6 | abort (1)、unsafe 类型转换 (4)、unsafe cast (1) |
