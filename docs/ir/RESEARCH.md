...
> 2026-09-22 路线复核：本文件为历史研究：所查公开 compiler 提交为 2025-09-29，并非当前 v0.10.14 的配套源码。下文“自建 IR 主路线”“类型重建不可避免”“100% 精度分派”“低成本 dump 入口”和 registry 全量结论不再作为当前决策依据。当前决策见 [基础设施与组件取舍](../moonbit-infrastructure-research-2026-09-22.md)。
